<?php 
	if(isset($_POST['save-sheet'])){
		...
		$submitted=0;
			...
			$db_sql = sprintf("INSERT INTO timesheets (USERID, WeekStart, Monday,  Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday, Saved_status, Submitted) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');", $id, $week, $monday, $tuesday, $wednesday, $thursday, $friday, $saturday, $sunday, $saved, $submitted);
